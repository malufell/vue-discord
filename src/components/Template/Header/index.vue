<template>
  <header class="header">
    ...
    <div class="header__channels">
      <div class="header__channels_name">
        <span>Dev Server</span>
      </div>

      <div class="header__channels_icon-options">
    ...
    <div class="header__chat">
      <div class="header__chat_name">
        <svg class="header__chat_name-icon" width="24" height="24">
        ...
        <span class="header__chat_name-channel">nome do canal selecionado</span>
      </div>

      <div class="header__chat_options">
        <!-- CONVERSAS -->
        <div>
          <svg width="24" height="24">
            ...
            <path d="M13.4399 12.96C12.9097 12.96 12.4799 13.3898 12.4799 13.92V20.2213C12.4799 20.7515 12.9097 21.1813 13.4399 21.1813H14.3999C14.5325 21.1813 14.6399 21.2887 14.6399 21.4213V23.4597C14.6399 23.6677 14.8865 23.7773 15.0408 23.6378L17.4858 21.4289C17.6622 21.2695 17.8916 21.1813 18.1294 21.1813H22.5599C23.0901 21.1813 23.5199 20.7515 23.5199 20.2213V13.92C23.5199 13.3898 23.0901 12.96 22.5599 12.96H13.4399Z"></path>
          </svg>
        </div>
        ...
        <!-- ESCONDER LISTA DE USUÁRIOS -->
        <div>
          <svg width="24" height="24" class="hide-users">
...
<style lang="scss">
  ...
  .header {
    ...
    &__chat {
      ...
      &_options {
        @include alignFlex(row, space-around);
        width: 30%;
        fill: $bg-color-white;
