<template>
  <div class="server-list">
    ...
    <div class="server-list__icon-options start">
    ...
    <div class="server-list__icon-options explorer">
      <svg width="18" height="18" viewBox="0 0 18 18">
        <path
          d="M18 8.001H10V0.000976562H8V8.001H0V10.001H8V18.001H10V10.001H18V8.001Z"
        />
      </svg>
    </div>
